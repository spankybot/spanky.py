...
async def update_banner(server, storage):
    ...
    while True:
        font = ImageFont.truetype(
            'plugin_data/fonts/OpenSansCondensed-Bold.ttf', text_size)
        text_width, text_height = img_draw.textsize(
            storage["banner_text"], font=font)
    ...
    img_draw.text((0, BANNER_H - text_height - TEXT_SPACE_H),
