...
_NEWCLI = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="methods",
            full_name="spanky.NewCli.methods",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_ACKCLI = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="methods",
            full_name="spanky.AckCli.methods",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_WORKREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="workThis",
            full_name="spanky.WorkRequest.workThis",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_WORKRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="workResult",
            full_name="spanky.WorkResponse.workResult",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
NewCli = _reflection.GeneratedProtocolMessageType(
    "NewCli",
    (_message.Message,),
    dict(
        DESCRIPTOR=_NEWCLI,
...
AckCli = _reflection.GeneratedProtocolMessageType(
    "AckCli",
    (_message.Message,),
    dict(
        DESCRIPTOR=_ACKCLI,
...
WorkRequest = _reflection.GeneratedProtocolMessageType(
    "WorkRequest",
    (_message.Message,),
    dict(
...
WorkResponse = _reflection.GeneratedProtocolMessageType(
    "WorkResponse",
    (_message.Message,),
    dict(
