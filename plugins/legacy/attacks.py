...
def load_attacks():
    ...
    with codecs.open(os.path.join("plugin_data/compliments.json"), encoding="utf-8") as f:
        compliments = json.load(f)

    with codecs.open(os.path.join("plugin_data/north_korea.txt"), encoding="utf-8") as f:
